    ...
    <main id="main">
      <div class="container-lg">
        <div class="row" id="container-grid">
          ...
          <div class="col-sm-2 col-md-6" id="container-navigation">
            <!--INSERIR TELA DE LOGIN AQUI-->
            <!--INSERÇÃO DO CARD-->
            <div class="row" style="padding: 25px;">
              <div class="col-10 br-card">
                <div class="br-card" id="card0">
                  <div class="card-content">
                    <h3 class="text-sm-center">Acesse sua conta com</h3>
                  </div>
                  <!-- CAMPO DE TEXTO RG JÁ FORMATADO -->
                  <form method="post" action="..\..\..\..\Controller\ControladorLogin.php">
                    <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                      <div class="col-sm-10">
                        <div class="br-input">
                          <label for="rg">RG</label>
                          <input name="rg" id="rg" oninput="mascaraRG(this)" type="text" placeholder="Digite somente números" required>
                        </div>
                      </div>
                    </div>
                    <!--FIM CAMPO DE TEXTO RG-->
                    <!--CAMPO DE TEXTO CPF JÁ FORMATADO-->
                    <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                      <div class="col-sm-10">
                        <div class="br-input">
                          <label for="cpf">CPF</label>
                          <input name="cpf" id="cpf" oninput="mascaraCPF(this)" type="text" placeholder="Digite somente números" required>
                        </div>
                      </div>
                    </div>
                    <!--FIM CAMPO DE TEXTO CPF-->
                    <p class="text-sm-center text-danger" style="padding-left: -10px;">
                      <?php
                    ...
                    <!--BOTÃO DE ENTRAR-->
                    <input type="hidden" name="acao" value="login1">
                    <input class="br-button primary mt-3 mt-sm-0 ml-sm-3" style="margin-bottom: 15px;" type="submit" value="Entrar">
                  </form>
          ...
          <!--FIM AREA DE LOGIN-->
          <!--INICIO AREA DOS GIFS VACINOMETRO-->
          <div class="col" id="container-content">
            ...
            <div class="main-content pl-3" id="main-content">
              ...
              <div class="row-content">
                <div data-panel="">
                  <div class="tile tile-default" id="d54256bb-f437-4dfb-a587-b1cfc2df4791">
                    <div class="cover-banner-tile tile-content">
                      <a href="https://qsprod.saude.gov.br/extensions/DEMAS_C19Vacina/DEMAS_C19Vacina.html">
                        <img src="../../../../imagens/Gif1.2.gif" width='1200px' height="205" alt="" style="margin-bottom: 2px; margin-top: 15px;">
                      </a>
                ...
                <div data-panel="">
                  <div class="tile tile-default" id="ab890b37-761d-47ed-a8af-5ea466fdb428">
                    <div class="cover-banner-tile tile-content">
                      <a href="https://qsprod.saude.gov.br/extensions/DEMAS_C19Vacina/DEMAS_C19Vacina.html">
                        <img src="../../../../imagens/Gif2.3.gif" width='1200px' height="205" alt="">
                      </a>
                      <div class="visualClear">
                        <!-- -->
                      </div>
