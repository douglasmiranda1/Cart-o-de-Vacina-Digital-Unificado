<?php
  session_start();
  require("..\..\..\..\Model\ClasseResultadoConsultaPacienteAplicadorDAO.php");
  $ResultadoConsultaPacienteAplicadorDAO = new ResultadoConsultaPacienteAplicadorDAO();
?>
<!DOCTYPE html>
<html lang="pt-BR">
                ...
                <div class="menu-container">
                  <div class="menu-panel">
                    <nav class="menu-body"  >
                      <div class="folder">
                        <ul>
                          <li><a class="menu-item active" href="ConsultarPacienteAplicador.php"><span class="content">Consultar Paciente</span></a></li>
                          <li><a class="menu-item active" href="CadastrarPacienteAplicador.php"><span class="content">Cadastrar Paciente</span></a></li>
                          <li><a class="menu-item" href="#"><span class="content">Cartão do Paciente</span><i class="fas fa-angle-right"></i></a></li>
                        </ul>
                      </div>
                    </nav>
                  </div>
                ...
                <div class="container-fluid">
                  <div class="br-table" data-search="data-search" data-selection="data-selection">
                    <div class="responsive" style="padding: 20px">
                      <table>
                        <div class="row">
                          <form name="consulta" method="post" action="..\..\..\..\Controller\ControladorAlterarRegistroAplicador.php">
                            <div class="col-sm-5">
                              <div class=" p-1">
                        ...
                        <form name="consulta" method="post" action="..\..\..\..\Controller\ControladorAlterarPacienteAplicador.php">
                          <tr>
                        ...
                        <?php $ResultadoConsultaPacienteAplicadorDAO->visualizarVacinasPaciente(); ?>
