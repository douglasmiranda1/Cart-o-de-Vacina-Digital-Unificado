                    ...
                    <nav class="menu-body">
                      <div class="folder">
                        <ul>
                          ...
                          <li><a class="menu-item " href="#"><span class="content">Alterar Cadastro Funcionario</span><i class="fas fa-angle-right"></i></a></li>
                      ...
                      <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col-sm-10">
                          <div class="br-input">
                            ...
                            <input id="especialidade" type="text" placeholder="Informe o Cargo" class="" style="width: 578px" name="especialidade" value="<?php echo $_SESSION["especialidade"]; ?>">
                          </div>
                        </div>
                      </div>
                      <!--FIM CAMPO DE TEXTO DOSE-->
