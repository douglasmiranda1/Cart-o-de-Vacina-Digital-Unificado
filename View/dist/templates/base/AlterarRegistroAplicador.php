      ...
      <div class="container-lg">
        <div class="row" id="container-grid">
                    ...
                    <nav class="menu-body">
                      <div class="folder">
                        <ul>
                          ...
                          <li><a class="menu-item " href="#"><span class="content">Alterar Registro de Aplicação de Dose</span><i class="fas fa-angle-right"></i></a></li>
                          <li><a class="menu-item active" href="ResultadoConsultaPacienteAplicador.php"><span class="content">Voltar ao Cartão do Paciente</span></a></li>
          ...
          <div class="row" style="padding: 25px; margin: auto;">
            <form name="adiciona" method="post" action="..\..\..\..\Controller\ControladorAlterarRegistroAplicador.php">
