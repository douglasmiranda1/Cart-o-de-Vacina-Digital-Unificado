        ...
        <div class="row" id="container-grid">
                    ...
                    <nav class="menu-body">
                      <div class="folder">
                        <ul>
                          ...
                          <li><a class="menu-item " href="#"><span class="content">Inserir Dose</span><i class="fas fa-angle-right"></i></a></li>
                          <li><a class="menu-item active" href="ResultadoConsultaPacienteAplicador.php"><span class="content">Voltar a Consulta do Paciente</span></a></li>
                        </ul>
                      </div>
                    </nav>
                  </div>
          ...
          <div class="col" id="container-content">
            <div class="main-content pl-3" id="main-content">
              <!--FIM MENU LATERAL CENTRO DA TELA-->
              <form name="consulta" method="post" action="..\..\..\..\Controller\ControladorInserirDoseAplicador.php">
