                    ...
                    <nav class="menu-body">
                      <div class="folder">
                        <ul>
                          ...
                          <li><a class="menu-item " href="#"><span class="content">Cadastrar Funcionário</span><i class="fas fa-angle-right"></i></a></li>
                ...
                <div class="col-12 br-card">
                  <div class="br-card" id="card0" style="width: 600px">
                    ...
                    <form name="adiciona" method="post" action="..\..\..\..\Controller\ControladorCadastroFuncionario.php">
                      ...
                      <!--FIM CAMPO DE TEXTO DOSE-->
                      <!-- CAMPO DE TEXTO CARGO JÁ FORMATADO -->
                      <div class="row justify-content-center mb-5" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col">
                          <div class="br-select">
                            <div class="br-input">
                              <label for="select-simple">Cargo</label>
                              <input id="select-simple" type="text" placeholder="Informe o Cargo" name="especialidade" class="" style="width: 578px">
                            </div>
