          ...
          <div class="col-sm-4 col-md-3" id="container-navigation">
            <div class="br-menu auxiliary">
              <div class="br-menu auxiliary">
                ...
                <div class="menu-container">
                  <div class="menu-panel">
                    <nav class="menu-body" style="width: 214px">
                      <div class="folder">
                        <ul>
                          <li><a class="menu-item" href="#"><span class="content">Consultar Paciente</span><i class="fas fa-angle-right"></i></a></li>
              ...
              <div class="row" style="padding: 25px; margin: auto;">
                <div class="col-12 br-card">
                  <div class="br-card" id="card0" style="width: 600px">
                    ...
                    <!--INICIO-->
                    <form method="post" action="..\..\..\..\Controller\ControladorConsultaPacienteAplicador.php">
